...
export function ProjectsPage({ onNavigateHome }: ProjectsPageProps) {
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-accent/5">
      ...
      <div className="sticky top-0 z-50 bg-background/95 backdrop-blur-sm border-b border-border/50">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-xl bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">
              Все проекты
            </h1>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        {/* Statistics */}
        <motion.div 
          className="bg-gradient-to-r from-primary/5 to-accent/10 rounded-2xl p-8 border border-primary/10"
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
